...
class TheMovieManagerVIPERLoginScreen: UIView {

    // MARK: Private Properties

    weak var delegate: TheMovieManagerVIPERLoginScreenDelegate?
...
extension TheMovieManagerVIPERLoginScreen: CodeView {
